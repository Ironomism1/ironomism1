<h1 align="center">Hey, I'm Shriyansh Mishra 👋</h1>
<p align="center">
  <b>AI Innovator • Full-Stack Developer • Hardware Designer • Explorer</b><br>
...
**Languages:**  
Java · Python · C++ · C · JavaScript · TypeScript · HTML · Inline CSS · PHP · SQL  

**Frameworks & Tools:**  
React · Node.js · MySQL · Git · Blender (beginner) · Webots · Ollama · Dolphin Model · Gemini API  

**Areas of Interest:**  
AI & LLMs · Embedded Systems · Full-Stack Development · Fine-Tuning Models · Space Tech · UI/UX Design  

---

## 🧩 Projects  

### 🐉 **1. Project Pegasus (Ongoing – 40%)**  
> **LLM Project | AI + Hardware Integration**

A large-scale project combining **AI fine-tuning**, **hardware design**, and **local model training**.  
I’m training an **open-source model (Dolphin)** with **Ollama**, running locally, and simulating its behavior in **Webots**.  
Includes **hardware integration using C**, **voice control in Python**, and a **React + JS interface**.  
Currently under development — focused on hardware synchronization and training simulation.
...
### 🎓 **4. Academia Ascend (SIH Hackathon Project)**  
> **Full-Stack Web App for College Management**
...
I served as the **design architect**, handled **frontend**, and took on **debugging & integration**.  
Though our team didn’t qualify, it was an incredible first hackathon that taught me leadership, collaboration, and system design.
...
- 🧩 **Smart India Hackathon (SIH)** – *Frontend Developer , Software  architect  & debugger*  
